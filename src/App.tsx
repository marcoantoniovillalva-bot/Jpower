  ...
  return (
    <div className="bg-black min-h-screen text-white selection:bg-[#F8C730] selection:text-black">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.92 }}
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.45)]"
      >
